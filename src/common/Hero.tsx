...
const Hero = () => {
  return (
    <div className="md:w-3/4 mx-auto pt-20 flex flex-col md:flex-row justify-between ">
      <div className="md:w-3/4 mx-auto p-5 flex flex-col justify-between ">
        <div className="space-y-10">
          ...
          <div className="h-12 w-3/4 bg-gray-100 rounded-md flex items-center space-x-2">
            <input
              type="text"
